...
// Logo Snapchat Officiel - Tracé Nettoyé et Proportionnel
const SnapchatIcon = ({ size, color }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path 
      d="M12 2.5c-2.812 0-4.661 1.637-4.661 4.225 0 1.25.688 2.062 1.3 2.587-.137.15-.312.375-.45.625-.337.588-.5 1.1-.5 1.775 0 .438.088.85.225 1.25-1.013.262-1.75.925-1.75 1.95 0 .5.188.937.5 1.3-.3 1.1-.3 1.713-.3 2.113 0 .5.175.837.475 1.075.15.113.313.2.475.25.138.413.513.725.963.725.125 0 .238-.025.338-.063.262.338.7.563 1.187.563.175 0 .338-.037.488-.087 1.112.562 2.375.887 3.662.887s2.55-.325 3.663-.887c.15.05.312.087.487.087.488 0 .925-.225 1.188-.563.1.038.212.063.337.063.45 0 .825-.312.963-.725.162-.05.325-.137.475-.25.3-.238.475-.575.475-1.075 0-.4 0-1.013-.3-2.113.312-.363.5-.8.5-1.3 0-1.025-.737-1.688-1.75-1.95.137-.4.225-.812.225-1.25 0-.675-.163-1.187-.5-1.775-.138-.25-.313-.475-.45-.625.612-.525 1.3-1.337 1.3-2.587 0-2.588-1.849-4.225-4.661-4.225z" 
      fill={color}
    />
  </svg>
);
