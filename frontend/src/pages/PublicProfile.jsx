...
import { Phone, Globe, Mail, Instagram, Facebook, Linkedin, ShieldAlert, Ghost } from 'lucide-react';

const API = "https://jamaney-backend.onrender.com/api";

// Logo TikTok personnalisé (plus fidèle que Music2)
...
export default function PublicProfile() {
  ...
  // Configuration des réseaux sociaux (Couleurs ou Jaune selon design_type)
  const socialIcons = [
    ...
    { id: 'snapchat', icon: <Ghost size={28} />, color: '#FFFC00', url: profile.snapchat } // Ajout Snapchat
  ];
  ...
  return (
    <div className="h-screen w-full bg-[#0a0a0b] flex justify-center items-center overflow-hidden font-sans">
      <div className="w-full max-w-[430px] h-full max-h-[932px] bg-gradient-to-b from-[#1a1a1c] via-[#121214] to-[#252529] relative flex flex-col shadow-2xl border-x border-white/5">
        ...
        {/* Profil Section - PHOTO AVEC BORDURE BLANCHE */}
        ...
        {/* Coordonnées - ICÔNES GRISÉES / ÉPURÉES */}
        ...
        {/* Réseaux Sociaux - COULEURS CONDITIONNELLES (Jaune ou Réel) */}
