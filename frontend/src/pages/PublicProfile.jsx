...
const SnapchatIcon = ({ size, color }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2C9.2 2 7 3.8 7 6.5c0 1.4.8 2.3 1.5 2.8-.2.3-.4.6-.5.9-.3.6-.4 1.2-.4 1.9 0 .5.1.9.2 1.3-1 .3-1.7 1-1.7 2 0 .6.2 1 .5 1.4-.3.4-.5 1-.5 1.7 0 .7.2 1.1.6 1.5.1.2.3.4.6.5.1.5.6.8 1.1.8.1 0 .3 0 .4-.1.3.4.8.7 1.3.7.2 0 .4 0 .6-.1 1.2.6 2.6 1 4 1s2.8-.4 4-1c.2.1.4.1.6.1.5 0 1-.3 1.3-.7.1.1.2.1.4.1.5 0 1-.3 1.1-.8.2-.1.4-.3.6-.5.4-.4.6-.8.6-1.5 0-.7-.2-1.3-.5-1.7.3-.4.5-.8.5-1.4 0-1-.7-1.7-1.7-2 .1-.4.2-.8.2-1.3 0-.7-.1-1.3-.4-1.9-.1-.3-.3-.6-.5-.9.7-.5 1.5-1.4 1.5-2.8C17 3.8 14.8 2 12 2z"/>
  </svg>
);
